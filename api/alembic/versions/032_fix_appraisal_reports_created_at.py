# ABOUTME: Fix migration — adds missing created_at column to appraisal_reports.
# ABOUTME: The original 001 migration omitted this column; seed scripts assumed it existed.
"""Fix — add created_at to appraisal_reports

Revision ID: 032
Revises: 031
Create Date: 2026-05-03 00:00:00.000000

The appraisal_reports table was created in migration 001 without a
...
def downgrade() -> None:
    op.drop_column("appraisal_reports", "created_at")
